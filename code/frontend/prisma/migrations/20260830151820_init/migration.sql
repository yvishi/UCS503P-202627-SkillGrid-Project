-- CreateEnum
CREATE TYPE "EvidenceSource" AS ENUM ('GITHUB', 'RESUME', 'LINKEDIN', 'PEER_FEEDBACK');
...
-- CreateIndex
CREATE INDEX "evidence_records_userId_source_idx" ON "evidence_records"("userId", "source");
